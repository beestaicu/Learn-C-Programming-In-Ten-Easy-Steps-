namespace GameClasses
{
    public partial class Form1 : Form
    {
        ...
        private void createObjectsBtn_Click(object sender, EventArgs e)
        {
            Thing th1;
            Thing th2;
            Treasure tr1;
            ...
            th1 = new Thing("A thinggummy: ", "A rather boring object");
            ...
            textBox1.Text = "Here this is...\r\n" +
                ...
                r2.Name + r2.Description + "with exists to " + r2.N + ", " + r2.S + ", " + r2.W + " and " + r2.E + "\r\n";
        }
    }
}