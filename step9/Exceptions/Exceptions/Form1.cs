namespace Exceptions
{
    public partial class Form1 : Form
    {
        ...
        private void Calc2Btn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Awfully sorry to bother you, but apparently the " + exc.Message, "Oop! There has been an error of the type: " + exc.GetType(),
        ...
        private void Calc3Btn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Try a samller number! " + exc.Message, "Yikes! Overflow error: " + exc.GetType(),
        ...
        private void Calc5Btn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Thank you for using our calculator", "Goodbyre",
                    MessageBoxButtons.OK, MessageBoxIcon.Information);
                tax = st * 0.175;
                gt = st + tax;
                taxBox.Text = tax.ToString();
